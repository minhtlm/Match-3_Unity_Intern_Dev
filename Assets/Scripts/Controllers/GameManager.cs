...
public class GameManager : MonoBehaviour
{
    ...
    public void LoadLevelAutoWin()
    {
        LoadLevel(eLevelMode.MOVES);

        if (m_boardController != null)
        {
            m_boardController.SetAutoWin(true);
        }
    }

    public void LoadLevelAutoLose()
    {
        LoadLevel(eLevelMode.MOVES);

        if (m_boardController != null)
        {
            m_boardController.SetAutoLose(true);
        }
    }
    ...
    private IEnumerator WaitBoardController(bool isWin = false)
    {
        ...
        State = isWin ? eStateGame.WIN : eStateGame.GAME_OVER;
